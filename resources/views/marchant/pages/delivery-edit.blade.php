        ...
        <div class="col-md-9 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('delivery.update', $delivery->id)}}" class="forms-sample" method="post">
                        @csrf
                        @method ('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <select name="divisions" class="form-control" id="divisions" onchange="divisionsList();">
                                <option value="{{ $delivery->divisions }}" disabled selected>{{ $delivery->divisions }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="district" class="form-control" id="distr" onchange="thanaList();">
                                <option value="{{ $delivery->district }}" disabled selected>{{ $delivery->district }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="police_station" class="form-control" id="polic_sta">
                                <option value="{{ $delivery->police_station }}" disabled selected>{{ $delivery->police_station }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_type" class="form-control" id="category">
                                <option value="{{ $delivery->category_type }}" disabled selected>{{ $delivery->category_type }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="exchange_parcel" class="form-control" id="category">
                                <option value="{{ $delivery->exchange_parcel }}" disabled selected>{{ $delivery->exchange_parcel }}</option>
