                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#"
                            ...
                            <div class="nav-profile-text">
                                <p class="mb-1 text-black">{{ $pickupman->pickupmen_name }}</p>
                            </div>
                        </a>
                        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">

                            <a class="dropdown-item" href="{{ route('pickupman.edit') }}">
                                <i class="mdi mdi-account-card-details me-2 text-success"></i> Update Profile </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{ route('pickupman.change.password') }}">
                                <i class="mdi mdi-account-key me-2 text-primary"></i> Change Password </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{ route('pickupman.delete') }}">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('pickupman.product.table') }}">Delivery Product</a></li>
