    ...
    <div class="conatiner-scroller">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="{{ route('pickupman.dashboard') }}"><img
                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#"
                            ...
                            <div class="nav-profile-img">
                                ...
                                <img src="{{asset('pickupmen/profile_images')}}/{{$pickupman->profile_img}}" alt="image">
                                <span class="availability-status online"></span>
                            </div>
                            <div class="nav-profile-text">
                                <p class="mb-1 text-black">{{ $pickupman->pickupman_name }}</p>
                            </div>
                        </a>
                        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">

                            <a class="dropdown-item text-dark" href="{{ route('pickupman.edit') }}">
                                <i class="mdi mdi-account-card-details me-2 text-success"></i> Update Profile </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item text-dark" href="{{ route('pickupman.change.password') }}">
                                <i class="mdi mdi-account-key me-2 text-primary"></i> Change Password </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item text-dark" href="{{ route('pickupman.delete') }}">
                                <i class="mdi mdi-account-key me-2 text-primary"></i> Delete Account </a>
                            {{-- <form action="{{ route('admin.delete') }}" method="get">
                                @csrf
                                <button class="dropdown-item" type="submit"
                                    onclick="return confirm('Are you sure?')"><i
                                        class="mdi mdi-account-remove me-2 text-primary"></i> Delete Account</button>
                            </form> --}}
                            <div class="dropdown-divider"></div>

                            <form action="{{ route('pickupman.logout') }}" method="post">
                                @csrf
                ...
                <ul class="nav">
                    <li class="nav-item nav-profile">
                        <a href="#" class="nav-link">
                            ...
                            <div class="nav-profile-text d-flex flex-column">
                                    <span class="font-weight-bold mb-2">{{$pickupman->pickupman_name}}</span>
                                    <span class="text-secondary text-small">Pickup Man</span>
                            </div>
                            <i class="mdi mdi-bookmark-check text-success nav-profile-badge"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('pickupman.dashboard') }}">
                            <span class="menu-title">Dashboard</span>
                            <i class="mdi mdi-home menu-icon"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('pickupman.product.table') }}">
                            <span class="menu-title">Parcel Table</span>
                            <i class="mdi mdi-shopping menu-icon"></i>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('pickupman.fraud_check') }}">
                    ...
                    {{-- <li class="nav-item">
                        ...
                        <div class="collapse" id="general-pages">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="marchant/pages/samples/blank-page.html"> Blank
                                        Page </a></li>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    @hasSection('content')
                        @yield('content')
                    @else
                        <h1 style="text-align: center;">Here is no pickupman content...</h1>
                    @endif
                </div>
            </div>
