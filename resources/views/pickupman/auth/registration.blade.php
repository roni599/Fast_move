...
<body>
    ...
    <div class="form-box w-75">
        ...
        <h2 class="text-center mb-3">Become a Pickup Man</h2>
        ...
        <form action="{{route('pickupman.store')}}" method="post" class="text-center p-2 d-flex" enctype="multipart/form-data">
            @csrf

            <div class="w-50 left text-light">

                <input type="text" class="form-control w-75 mx-auto" name="pickupman_name"
                    value="{{ old('pickupman_name') }}" placeholder="Pickupman Name">
                <span class="text-danger mb-3 d-block">
                    @error('pickupman_name')
                        {{ $message }}
                    @enderror
                </span>
