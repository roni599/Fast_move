            ...
            <div class="col-lg-12">
                <div class="w-100 bg-white rounded p-4">
                    <h5 class="text-color-5 px-3 font-20 fw-bold">Entry Fraudulent Activity
                        <a href="{{ route('deliveryman.fraud_check') }}" class="btn btn-sm btn-info">View All</a>
                    </h5>
                    <hr>
                    ...
                    <div class="tab-content p-3">
                        <div class="tab-pane d-block">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="POST" action="{{ route('deliveryman.fraud_add_new_insert') }}">
                                        @csrf
                                        <input type="hidden" name="user_id" value="{{ $deliveryman->id }}">
