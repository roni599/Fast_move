...
<div class="card mb-3">
        <div class="card-body">
            <nav class="navbar navbar-light bg-light">
                    ...
                    <form id="excel" action="{{ route('admin.excel.import') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="input-group mb-0">
                            <div class="form-group-feedback form-group-feedback-left">
    ...
    <script>
        $(document).ready(function() {
            ...
            // Declare resultsBody outside the success function
            var resultsBody = $('#searchResultsBody');
            ...
            $('#searchForm').submit(function(e) {
                ...
                // Determine the route dynamically based on your logic
                var searchRoute = '{{ route('admin.adminSearch') }}'; // You can modify this based on your requirements
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        // Use resultsBody here as well if needed
                        resultsBody.html(
