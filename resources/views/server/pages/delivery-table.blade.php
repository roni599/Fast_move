                ...
                <div class="table-responsive bg-light">
                    <table class="table table-light table-hover">
                        ...
                        @foreach ($deliveries as $delivery)
                            <tr class="table-info">
                                <td>{{ $delivery->id }}</td>
                                <td>{{ $delivery->user->fname }} {{ $delivery->user->lname }}</td>
                                <td>{{ $delivery->name }}</td>
                                ...
                                <td>
                                    @if ($delivery->is_active == 1)
                                        <div class="d-flex justify-center align-items-center gap-2">
                                            <form action="{{ route('admin.delivery_confirmation') }}" method="post">
                                                @csrf
                                            ...
                                            <form action="{{ route('admin.cancel_confirmation') }}" method="post">
                                                @csrf
                                                <input type="hidden" name="id" value="{{ $delivery->id }}">
                                    ...
                                    @elseif ($delivery->is_active == 2)
                                        <form action="{{ route('admin.delivery_checkout') }}" method="post">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $delivery->id }}">
                                    ...
                                    @elseif ($delivery->is_active == 3)
                                        <form action="{{ route('admin.delivery_delivered') }}" method="post">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $delivery->id }}">
                                            <button class="btn btn-sm btn-success" type="submit">
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <form action="{{ route('admin.delivery.edit') }}" method="get">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $delivery->id }}">
                                        ...
                                        <form action="{{ route('admin.delivery.delete') }}" method="get">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $delivery->id }}">
                                            <button class="btn btn-sm btn-danger" type="submit"
